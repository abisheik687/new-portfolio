...
const GenerateProjectDescriptionInputSchema = z.object({
  codePreview: z
    .string()
    .describe('A code preview of the project.'),
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert software developer who is very good at explaining code to non-technical people.

  Please generate a description for the following project, based on the code preview:
